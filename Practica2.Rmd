...
Comprobamos que hay una serie de variables categóricas, las cuales vamos a factorizar. Y el resto de variables contínuas vamos a cambiar el tipo a numéricas.
