...
```{r}
shapiro.test(heart.norm$age)$p.value
shapiro.test(heart.norm$trtbps)$p.value
shapiro.test(heart.norm$thalachh)$p.value
shapiro.test(heart.norm$oldpeak)$p.value
```
